...
<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <h2 class="text-2xl font-semibold text-gray-800">Monthly Report</h2>
    ...
    <form class="flex flex-wrap gap-3 items-center mb-4" method="GET">
        ...
        <a href="{{ route('reports.monthly.pdf', ['month'=>$month]) }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">Download PDF</a>
    </form>
    ...
    <div class="bg-white shadow rounded-lg p-4">
        ...
        <p class="text-gray-700"><span class="font-medium">Total Income:</span> {{ number_format($totalIncome,2) }}</p>
        <p class="text-gray-700"><span class="font-medium">Total Expense:</span> {{ number_format($totalExpense,2) }}</p>
        <p class="text-gray-700"><span class="font-medium">Balance:</span> {{ number_format($balance,2) }}</p>
    </div>
