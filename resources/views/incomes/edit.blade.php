...
<div class="space-y-6">
    ...
    <h2 class="text-2xl font-semibold text-gray-800">Edit Income</h2>
    ...
    <form action="{{ route('incomes.update', $income) }}" method="POST" class="space-y-4 bg-white shadow rounded-lg p-6">
        ...
        <div class="flex gap-2">
            <button type="submit" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition">Update</button>
